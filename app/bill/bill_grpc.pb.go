...
func (c *serviceClient) SaveBill(ctx context.Context, in *Bill, opts ...grpc.CallOption) (*Bill, error) {
	out := new(Bill)
	err := c.cc.Invoke(ctx, "/ericyaoxr.cmdb.bill.Service/SaveBill", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *serviceClient) QueryBill(ctx context.Context, in *QueryBillRequest, opts ...grpc.CallOption) (*BillSet, error) {
	out := new(BillSet)
	err := c.cc.Invoke(ctx, "/ericyaoxr.cmdb.bill.Service/QueryBill", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Service_SaveBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ericyaoxr.cmdb.bill.Service/SaveBill",
	}
...
func _Service_QueryBill_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ericyaoxr.cmdb.bill.Service/QueryBill",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ericyaoxr.cmdb.bill.Service",
